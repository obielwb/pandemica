...
def add_individual(rtree_index, individual):
    rtree_index.insert(id(individual), (individual.x,
                       individual.y, individual.x, individual.y))
...
def main():
    ...
    individuals_around_target = find_individuals_around(
        rtree_index, target_x, target_y, search_radius)
