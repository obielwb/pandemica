...
var _chunkT2XB52TLjs = require('./chunk-T2XB52TL.js');
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        ...
        sveltePreprocessor = sveltePreprocessor || _chunkOSC67C6Mjs.localRequire.call(void 0, "svelte-preprocess");
        if (!svelte) {
          return {
  ...
  async buildFinished({
    ...
    const files = outputFiles.filter((file) => !file.path.endsWith(".map")).map((file) => {
      ...
      if (isJS(file.path) || isCSS(file.path)) {
        ...
        const meta = metafile == null ? void 0 : metafile.outputs[relativePath];
        return {
          type: "chunk",
          path: file.path,
          code: file.text,
          map: (_a = outputFiles.find((f) => f.path === `${file.path}.map`)) == null ? void 0 : _a.text,
          entryPoint: meta == null ? void 0 : meta.entryPoint,
          exports: meta == null ? void 0 : meta.exports,
          imports: meta == null ? void 0 : meta.imports
        };
      } else {
...
async function build(_options) {
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger = _chunkCTQOVGLWjs.createLogger.call(void 0, item == null ? void 0 : item.name);
        const options = await normalizeOptions(logger, item, _options);
        logger.info("CLI", `tsup v${_chunkT2XB52TLjs.version}`);
        if (config.path) {
          ...
          if (!((_a = options.dts) == null ? void 0 : _a.only)) {
            ...
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunkOSC67C6Mjs.removeFiles.call(void 0, ["**/*", ...extraPatterns], options.outDir);
