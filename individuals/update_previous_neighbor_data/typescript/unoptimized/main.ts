...
const instances: Individual[] = Array.from({ length: 1223237 }, () => new Individual())
const size = instances.reduce((acc, instance) => acc + JSON.stringify(instance).length, 0) // 280121273 bytes - 280 mb
